...
import ca.dnamobile.javalauncher.renderer.GemMesaSupport;
...
public class MinecraftGLSurface extends FrameLayout implements GrabListener {
    ...
    private boolean shouldForceZinkNativeSurfaceRgba8888() {
        if (GemMesaSupport.shouldForceNativeSurfaceRgba8888()) return true;
        ...
        return envContains("POJAV_RENDERER", "vulkan_zink")
                ...
                || envEquals("GEM_ADRENO740_SURFACE_RGBA8888", "1")
                || envEquals("GEM_ZINK_V57_FORCE_OSMESA_EGL", "1")
                || envEquals("GEM_FREEDRENO_V57_PURE_ZINK_ALIAS", "1");
    }
    ...
    private boolean shouldForceDirectFreedrenoOpaqueRgbx8888() {
        ...
        return envEquals("GEM_DIRECT_FREEDRENO_OPAQUE_RGBX8888", "1")
                || envEquals("GEM_EGL_FORCE_RGBX8888", "1");
    }

    private boolean shouldForceDirectFreedrenoNativeSurface() {
        // v70: do not force SurfaceView for the Mojo-style direct KGSL path.
        // Mojo's OpenJDK/Cacio route is closer to Gem's TextureView path than
        ...
        return envEquals("GEM_DIRECT_FREEDRENO_NATIVE_SURFACE_V69", "1")
                && !envEquals("GEM_DIRECT_FREEDRENO_TEXTUREVIEW_V70", "1");
    }
    ...
    public void start(boolean isAlreadyRunning) {
        ...
        if (useNativeSurfaceView) {
            ...
            if (envEquals("GEM_DIRECT_FREEDRENO_TEXTUREVIEW_V70", "1")) {
