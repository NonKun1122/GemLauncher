 ...
 * All rights reserved.
 *
 * Gem launcher-side helper for renderer APK plugins.
 */
...
public final class LiteGlesLaunchPreloader {
    ...
    public static Result prepare(@NonNull Context launcherContext,
        ...
        System.out.println("GemLiteGLES: provider profile before native load="
        ...
        System.setProperty("gem.osmesa.path", stagedOSMesa.getAbsolutePath());
        System.setProperty("gem.renderer.plugin.nativeDir", pluginNativeDir.getAbsolutePath());
        System.setProperty("gem.renderer.stagedNativeDir", stagedNativeDir.getAbsolutePath());
        System.setProperty("gem.litegles.profile", providerProfile);
        ...
        System.out.println("GemLiteGLES: staged libOSMesa=" + stagedOSMesa.getAbsolutePath());
        System.out.println("GemLiteGLES: staged libOSMesa_8=" + stagedOSMesa8.getAbsolutePath());
        System.out.println("GemLiteGLES: staged libGL=" + stagedGL.getAbsolutePath());
    ...
    private static Bundle readProviderBundle(@NonNull Context context) {
        try {
            ...
            if (b != null) {
                System.out.println("GemLiteGLES: provider config version="
                        + b.getString("version", "")
            ...
            System.out.println("GemLiteGLES: provider config unavailable -> " + t);
            return null;
        }
    }
    ...
    private static File stageAliases(@NonNull File pluginNativeDir,
        ...
        copyAlways(main, new File(stagedNativeDir, "libgem_litegl.so"));
        ...
        return new File(stagedNativeDir, "libgem_litegl.so");
    }
