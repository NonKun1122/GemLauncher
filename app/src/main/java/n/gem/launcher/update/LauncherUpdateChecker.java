...
public final class LauncherUpdateChecker {
    ...
    private static final String REPO = "GemLauncher";
    ...
    private static final String LATEST_RELEASE_URL =
            "https://api.github.com/repos/DNAMobileApplications/GemLauncher/releases/latest";
    ...
    private static String getJson(@NonNull String requestUrl) throws Exception {
        ...
        try {
            ...
            connection.setRequestProperty("User-Agent", "GemLauncher/" + BuildConfig.VERSION_NAME);
